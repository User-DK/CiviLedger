...
//         ...formData,
//         testers: testers.join(','), // Convert array to comma-separated string
//         entered_by: entered_by.join(','),
...
//       <View style={styles.row}>
//         <MultiSelect
//           items={testers.map((code) => ({ id: code, name: code }))}
//           uniqueKey="id"
//           onSelectedItemsChange={(selectedItems) =>
//             handleChange('testers', selectedItems)
//           }
//           selectedItems={formData.testers}
//           selectText="Select Testers"
//           searchInputPlaceholderText="Search Testers..."
...
//         />
//         <MultiSelect
//           items={consultants.map((code) => ({ id: code, name: code }))}
//           uniqueKey="id"
//           onSelectedItemsChange={(selectedItems) =>
//             handleChange('entered_by', selectedItems)
//           }
//           selectedItems={formData.entered_by}
//           selectText="Select Entered By"
//           searchInputPlaceholderText="Search Consultants..."
//           tagRemoveIconColor="#CCC"
//           tagBorderColor="#CCC"
//           tagTextColor="#000"
//           selectedItemTextColor="#CCC"
